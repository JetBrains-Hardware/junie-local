...
- **Engine:** `junie-mlx-vlm` v0.1.3, unpacked under `~/.local/share/junie-local/versions/`.
...
{"event":"config","port":19239,"ram_gb":35,"engine_version":"0.1.3","checks_passed":true}
...
|---|---|---|
| **junie-mlx-vlm 0.1.3** | ~180 MB (~470 MB unpacked) | `~/.local/share/junie-local/versions/0.1.3/` |
